...
// Source: github.com/olicesx/quic-go (interfaces: ConnRunner)
//
// Generated by this command:
//
//	mockgen -typed -build_flags=-tags=gomock -package quic -self_package github.com/olicesx/quic-go -destination mock_conn_runner_test.go github.com/olicesx/quic-go ConnRunner
//
...
func (m *MockConnRunner) ReplaceWithClosed(arg0 []protocol.ConnectionID, arg1 []byte, arg2 net.Addr) {
	m.ctrl.T.Helper()
...
// Do rewrite *gomock.Call.Do
func (c *MockConnRunnerReplaceWithClosedCall) Do(f func([]protocol.ConnectionID, []byte, net.Addr)) *MockConnRunnerReplaceWithClosedCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockConnRunnerReplaceWithClosedCall) DoAndReturn(f func([]protocol.ConnectionID, []byte, net.Addr)) *MockConnRunnerReplaceWithClosedCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
