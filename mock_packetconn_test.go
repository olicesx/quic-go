...
//
//	mockgen -typed -package quic -self_package github.com/olicesx/quic-go -self_package github.com/olicesx/quic-go -destination mock_packetconn_test.go net PacketConn
//
